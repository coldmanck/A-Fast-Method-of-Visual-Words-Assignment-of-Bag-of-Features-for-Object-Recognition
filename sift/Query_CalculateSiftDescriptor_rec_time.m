function [database, lenStat, D] = Query_CalculateSiftDescriptor_rec_time(rt_img_dir, rt_data_dir, gridSpacing, patchSize, maxImSize, nrml_threshold)
%==========================================================================
...
for ii = 1:length(subfolders),
    ...
    if ~strcmp(subname, '.') & ~strcmp(subname, '..'),
        ...
        combined_crop_dir = strcat('cropped_images_query\', subname);
        if ~isdir(combined_crop_dir),
            mkdir(combined_crop_dir);
        end;
        ...
        for jj = 1:c_num,
            ...
            siftArr = sp_find_sift_grid_rec_time(I, gridX, gridY, patchSize, 0.8, subname, fname);
