...
for ii = 1:length(subfolders),
    ...
    if ~strcmp(subname, '.') & ~strcmp(subname, '..'),
        ...
        datadbase.cname{database.nclass} = subname;
        ...
        combined_crop_dir = strcat('cropped_images_cifar-10/', subname);
        ...
        for jj = 1:c_num,
            ...
            siftArr = sp_find_sift_grid(I, gridX, gridY, patchSize, 0.8, subname, fname);
