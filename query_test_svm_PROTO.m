...
save(['query_test_svm_PROTO_M', n_of_extract, '_N', N,'.mat'], 'SVM', 'predicted_label', 'acc', 'dic_value', 'predicted_label_p', 'acc_p', 'dic_value_p')
% [D1, D2, D3] = error_calc(LQ, SQ, QL, B);
