...
savRecPath = ['Results/', dataSet, '_n', num2str(n_of_extract), '_w', num2str(w), '_ivfpq_noreg.mat'];
save(savRecPath,'rec');
...
savRecPath = ['Results/', dataSet, '_n', num2str(n_of_extract), '_w',num2str(w),'_pq_noreg.mat'];
save(savRecPath,'rec');
